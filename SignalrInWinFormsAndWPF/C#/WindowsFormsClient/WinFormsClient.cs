...
namespace WinFormsClient
{
    ...
    public partial class WinFormsClient : Form
    {
        ...
        const string ServerURI = "http://localhost:8088/signalr";
        ...
        {
            RichTextBoxConsole.AppendText(String.Format("{0}: {1}" + Environment.NewLine, UserName, TextBoxMessage.Text));
        ...
        /// </summary>
        private async void ConnectAsync(string user)
        {
            Connection = new HubConnection(ServerURI);
            Connection.Headers.Add("UserName", user);
